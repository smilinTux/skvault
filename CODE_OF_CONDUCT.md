...
We as members, contributors, and leaders pledge to make participation in the `skvault`
...
Because `skvault` is **secrets-handling** software, positive conduct here also means:
...
- **Intellectual honesty about security claims.** Do not overstate assurance. We say
  ...
  "unbreakable," and we never describe the classical seal surface as post-quantum. Claims
...
- **Respect for sovereignty and privacy.** Never publish another person's or agent's
  private key, credential, or secret material; never weaken the never-holds-master
...
maintainer contact listed on the [`smilinTux/skvault`](https://github.com/smilinTux/skvault)
